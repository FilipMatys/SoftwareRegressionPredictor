System.register(['angular2/core', 'angular2/http', 'rxjs/Observable'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PollingService = (function () {
                ...
                PollingService.prototype.poll = function () {
                    ...
                    return Observable_1.Observable.interval(1000)
                        .flatMap(function () {
                        return _this.http.get(_this._pollingURL)
                            .map(function (res) { return res.json(); })
                            .catch(_this.handleError);
                    });
                };
                // Handle error
                PollingService.prototype.handleError = function (error) {
            ...
            exports_1("PollingService", PollingService);
        }
    }
});
