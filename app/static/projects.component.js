System.register(['angular2/core', 'angular2/router', './services/project.service'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ProjectsComponent = (function () {
                function ProjectsComponent(_router, _projectService) {
                ...
                ProjectsComponent.prototype.goToDetail = function (selectedId) {
                    this._router.navigate(['ProjectDetail', { id: selectedId }]);
                };
                ProjectsComponent.prototype.getProjects = function () {
                    var _this = this;
                    this._projectService.getProjects().subscribe(function (result) {
